...
public class IngredientGenerator : MonoBehaviour
{
    ...
    {
        while(ChoppingGameManager.Instance.GetIngredientCounter()<20) // Runs until 20 non tax folder spawn
        {
        ...
        finalScoreText.text = ChoppingGameManager.Instance.GetScore();
